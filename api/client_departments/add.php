...
$stmt = $pdo->prepare("
    INSERT INTO client_departments (client_id, department_id, custom_name, custom_short_name)
    VALUES (?, ?, ?, ?)
");
$stmt->execute([$clientId, $departmentId, $customName ?: null, $customShort ?: null]);
