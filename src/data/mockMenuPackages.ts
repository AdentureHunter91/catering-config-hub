...
const dishPool: MenuCellDish[] = [
  ...
  { id: 3, name: "Jabłko", kcal: 52, protein: 0.3, fat: 0.2, saturatedFat: 0, carbs: 14, sugars: 10, salt: 0, fiber: 2.4, cost: 1.0, allergenIcons: [],
    composition: [
      { name: "Jabłko świeże", type: "product", portionLabel: "150g", allergenCodes: [] },
    ] },
  { id: 4, name: "Marchewka (plasterki)", kcal: 41, protein: 0.9, fat: 0.2, saturatedFat: 0, carbs: 10, sugars: 5, salt: 0.1, fiber: 2.8, cost: 0.8, allergenIcons: [],
    composition: [
  ...
  { id: 10, name: "Kompot owocowy", kcal: 80, protein: 0, fat: 0, saturatedFat: 0, carbs: 20, sugars: 18, salt: 0, fiber: 0.5, cost: 1.2, allergenIcons: [],
    composition: [
      { name: "Kompot wieloowocowy", type: "recipe", portionLabel: "200ml", allergenCodes: [] },
    ] },
  { id: 11, name: "Budyń waniliowy", kcal: 150, protein: 4, fat: 5, saturatedFat: 3, carbs: 22, sugars: 16, salt: 0.2, fiber: 0, cost: 2.0, allergenIcons: ["🥛"],
    composition: [
