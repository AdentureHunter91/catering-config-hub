...
try {
    ...
    // Update allergens - delete old and insert new
    $deleteStmt = $pdo->prepare("DELETE FROM product_allergens WHERE product_id = ?");
    ...
    logAudit($pdo, 'products', $id, 'update', $oldRecord, $newRecord, $user['id'] ?? null);
